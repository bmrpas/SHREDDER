...
@section('contenido')
        ...
        <p class="lead">Use this document as a way to quickly start any new project.<br> All you get is this text and a mostly barebones HTML document.</p-->
          ...
          <p>"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum." bla bla
              ...
              {{ Form::open(array('url' => '/solicitud_info/crear', 'method' => 'GET'))}}
    
              {{ Form::submit('Nueva Solicitud de Información', array('class' => 'btn btn-primary')) }}
...
<div  class="row">
            ...
            <div  class="col-md-3"> {{ HTML::link('tres', $solicitud->persona->full_name.' | '.$solicitud->solicitud_info_fecha.' | '.$solicitud->solicitud_tipo, array('id' => 'nam_id'))}}</div>
...
@foreach ($solicitudes_empresa as $solicitud_empresa)
<div  class="row">
            <br/><br/>
            

            <div  class="col-md-3"> {{ HTML::link('tres', $solicitud_empresa->company->full_name.' | '.$solicitud_empresa->solicitud_info_fecha.' | '.$solicitud->solicitud_tipo, array('id' => 'nam_id'))}}</div>
