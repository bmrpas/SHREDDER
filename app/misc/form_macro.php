...
{  
  $item = '<input type="color" name="'. $name .'" ';="" if="" ($default)="" {="" $item="" .="value="" $default="" .'"="" }="" (is_array($attrs))="" foreach="" ($attrs="" as="" $a=""> $v) 
      $item .= $a .'="'. $v .'" '; 
  } 
  $item .= ">"; 
...
{ 
  $item = '<input type="date" name="'. $name .'" ';="" if="" ($default)="" {="" $item="" .="value="" $default="" .'"="" }="" (is_array($attrs))="" foreach="" ($attrs="" as="" $a=""> $v)  
      $item .= $a .'="'. $v .'" ';  
  }  
  $item .= ">";  
...
{  
  $item = '<input type="datetime" name="'. $name .'" ';="" if="" ($default)="" {="" $item="" .="value="" $default="" .'"="" }="" (is_array($attrs))="" foreach="" ($attrs="" as="" $a=""> $v) 
      $item .= $a .'="'. $v .'" '; 
  } 
  $item .= ">"; 
...
{  
  $item = '<input type="month" name="'. $name .'" ';="" if="" ($default)="" {="" $item="" .="value="" $default="" .'"="" }="" (is_array($attrs))="" foreach="" ($attrs="" as="" $a=""> $v) 
      $item .= $a .'="'. $v .'" '; 
  } 
  $item .= ">"; 
...
{ 
  $item = '<input type="number" name="'. $name .'" ';="" if="" ($default)="" {="" $item="" .="value="" $default="" .'"="" }="" (is_array($attrs))="" foreach="" ($attrs="" as="" $a=""> $v)  
      $item .= $a .'="'. $v .'" ';  
  }  
  $item .= ">";  
...
{  
  $item = '<input type="range" name="'. $name .'" ';="" if="" ($default)="" {="" $item="" .="value="" $default="" .'"="" }="" (is_array($attrs))="" foreach="" ($attrs="" as="" $a=""> $v) 
      $item .= $a .'="'. $v .'" '; 
  } 
  $item .= ">"; 
...
{ 
  $item = '<input type="search" name="'. $name .'" ';="" if="" ($default)="" {="" $item="" .="value="" $default="" .'"="" }="" (is_array($attrs))="" foreach="" ($attrs="" as="" $a=""> $v)  
      $item .= $a .'="'. $v .'" ';  
  }  
  $item .= ">";  
...
{  
  $item = '<input type="tel" name="'. $name .'" ';="" if="" ($default)="" {="" $item="" .="value="" $default="" .'"="" }="" (is_array($attrs))="" foreach="" ($attrs="" as="" $a=""> $v) 
      $item .= $a .'="'. $v .'" '; 
  } 
  $item .= ">"; 
...
{ 
  $item = '<input type="time" name="'. $name .'" ';="" if="" ($default)="" {="" $item="" .="value="" $default="" .'"="" }="" (is_array($attrs))="" foreach="" ($attrs="" as="" $a=""> $v)  
      $item .= $a .'="'. $v .'" ';  
  }  
  $item .= ">";  
...
{  
  $item = '<input type="week" name="'. $name .'" ';="" if="" ($default)="" {="" $item="" .="value="" $default="" .'"="" }="" (is_array($attrs))="" foreach="" ($attrs="" as="" $a=""> $v) 
      $item .= $a .'="'. $v .'" '; 
  } 
  $item .= ">";  
